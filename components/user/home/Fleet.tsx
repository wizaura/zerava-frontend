                ...
                <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        <h2
                            ...
                            className="text-3xl font-light text-gray-900 sm:text-5xl leading-tight"
                        >
                            Fleet & Corporate <br />
                        ...
                        <p
                            ...
                            className="mt-4 max-w-xl text-sm text-gray-600 sm:text-lg"
                        >
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        >
                            ...
                            <span className="absolute bottom-3 left-3 rounded-full bg-electric-teal px-4 py-1 
                        ...
                        {benefits.map((item, i) => {
                            ...
                            return (
                                <div
                                    ...
                                    data-aos-duration="800"
                                    className="group rounded-2xl bg-white p-6 shadow-sm transition-all
                             hover:-translate-y-2 hover:shadow-lg"
                                >
                                    <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-md 
                                  bg-electric-teal/10 group-hover:bg-electric-teal group-hover:text-white text-electric-teal">
                                        <Icon size={18} />
                                    </div>
